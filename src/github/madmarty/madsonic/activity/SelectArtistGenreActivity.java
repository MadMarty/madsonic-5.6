...
public class SelectArtistGenreActivity extends SubsonicTabActivity implements AdapterView.OnItemClickListener {

	private static final String TAG = SelectArtistGenreActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        actionSettingsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               	new PopupMenuHelper().showMenu(SelectArtistGenreActivity.this, actionSettingsButton, R.menu.common);
            }
        });
 ...
 //   	inflater.inflate(R.menu.main, menu);
    ...
    private void load() {
        BackgroundTask<List<Genre>> task = new TabActivityBackgroundTask<List<Genre>>(this, true) {
            ...
            protected List<Genre> doInBackground() throws Throwable {
                MusicService musicService = MusicServiceFactory.getMusicService(SelectArtistGenreActivity.this);
                
                List<Genre> genres = new ArrayList<Genre>(); 
                
                try {
                	genres = musicService.getArtistsGenres(SelectArtistGenreActivity.this, this);
                } catch (Exception x) {
                    Log.e(TAG, "Failed to load artistsgenres", x);
                }
            ...
            protected void done(List<Genre> result) {
            	...
            	if (result != null) {
            		genreList.setAdapter(new GenreAdapter(SelectArtistGenreActivity.this, result));
            	}
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
    	...
    	intent.putExtra(Constants.INTENT_EXTRA_NAME_ARTIST_GENRE_NAME, genre.getName());
