...
//    private boolean fullscreen;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		boolean fullscreen = Util.getThemeFullscreen(getBaseContext());
        ...
        if (!Util.isOffline(this)) {
        	Version ServerVersion = Util.getServerRestVersion(getBaseContext());
        	if (ServerVersion != null) { 
        		if ( ServerVersion.compareTo(new Version("1.10.5"))  >= 0 ) {
    ...
    private void loadSettings() {
        ...
        if (!prefs.contains(Constants.PREFERENCES_KEY_CACHE_LOCATION)) {
            ...
            editor.putString(Constants.PREFERENCES_KEY_CACHE_LOCATION, FileUtil.getMadsonicDirectory(this).getPath());
            editor.commit();
        } else {
		...
		try {
			...
			new ModalBackgroundTask<File>(this, false) {
				...
				protected File doInBackground() throws Throwable {
					...
					File logcat = new File(FileUtil.getMadsonicDirectory(getBaseContext()), "logcat.txt");
