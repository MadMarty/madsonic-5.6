...
public class SelectGenreActivity extends SubsonicTabActivity implements AdapterView.OnItemClickListener {
 ...
 //   	inflater.inflate(R.menu.main, menu);
    ...
    private void load() {
        BackgroundTask<List<Genre>> task = new TabActivityBackgroundTask<List<Genre>>(this, true) {
            ...
            protected void done(List<Genre> result) {
            	...
            	if (result != null) {
            		if (result.get(0).getAlbumCount() != null || 
            			result.get(1).getAlbumCount() != null || 
            			result.get(2).getAlbumCount() != null) {
                		genreList.addHeaderView(createHeader());
            		}
    ...
    private View createHeader() {
       View header = LayoutInflater.from(this).inflate(R.layout.select_genre_header, genreList, false);
       return header;
   }
