...
public class SubsonicTabActivity extends Activity {
    ...
    private View otherplayingButton;
    private View otherplayingButtonSep;
    ...
    protected void onPostCreate(Bundle bundle) {
        ...
        otherplayingButton = findViewById(R.id.button_bar_nowplayling);
        otherplayingButtonSep =  findViewById(R.id.nowplaying_separator);
        
        otherplayingButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
            	
    			Util.startActivityWithoutTransition(SubsonicTabActivity.this, NowplayingActivity.class);
            }
        });         
...
//      text.setText(title);
    ...
    public void applyTheme() {
        ...
        fullscreen = Util.getThemeFullscreen(this);
    ...
    private void updateButtonVisibility() {
		...
		if(prefs.getBoolean(Constants.PREFERENCES_KEY_NOWPLAYING_ENABLED, false)) {
			otherplayingButton.setVisibility(visibility);
			otherplayingButtonSep.setVisibility(visibility);
		} else {
			otherplayingButton.setVisibility(View.GONE);
			otherplayingButtonSep.setVisibility(View.GONE);        
		}		
...
//              Util.toast(SubsonicTabActivity.this, getResources().getString(R.string.starring_content_done, entry.getTitle()));
    ...
    protected void playYouTubeVideo(MusicDirectory.Entry entry)  {
        if (!Util.isNetworkConnected(this)) {
            Util.toast(this, R.string.select_album_no_network);
            return;
        }
		 String videoId = entry.getData();
