    ...
    private void populateList(boolean star) {
        ...
        if (searchResult != null) {
            ...
            if (!albums.isEmpty()) {
                ...
                albumAdapter = new EntryAdapter(this, getImageLoader(), displayedAlbums, false, false);
            ...
            if (!songs.isEmpty()) {
                ...
                songAdapter = new EntryAdapter(this, getImageLoader(), displayedSongs, false, false);
