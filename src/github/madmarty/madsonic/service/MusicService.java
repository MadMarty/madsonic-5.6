...
public interface MusicService {
    ...
    MusicDirectory getPandoraSongs(int id, Context context, ProgressListener progressListener) throws Exception;
	...
	MusicDirectory getNowplayingSongs(Context context, ProgressListener progressListener) throws Exception;
	...
	String getVideoUrl(String format, int maxBitrate, Context context, String id, boolean useFlash) throws Exception;
...
//	@Deprecated
//	String getVideoStreamUrl(String format, int maxBitrate, Context context, String id) throws Exception;
	...
	Bitmap getAvatar(Context context, String username, int size, int savesize, ProgressListener progressListener) throws Exception;
