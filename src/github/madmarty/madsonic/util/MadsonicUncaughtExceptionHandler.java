 ...
 */
public class MadsonicUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {

    private static final Logger LOG = new Logger(MadsonicUncaughtExceptionHandler.class);

    private final Thread.UncaughtExceptionHandler defaultHandler;
    private final Context context;

    public MadsonicUncaughtExceptionHandler(Context context) {
