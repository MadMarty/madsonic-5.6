...
public final class Constants {
    ...
    public static final String INTENT_EXTRA_NAME_TOPTRACK = "subsonic.toptrack";
    ...
    public static final String PREFERENCES_KEY_THEME_FULLSCREEN = "fullscreen";
    ...
    public static final String PREFERENCES_KEY_DISPLAY_DURATION_WITH_SONG = "displayDurationWithSong";
    public static final String PREFERENCES_KEY_DISPLAY_RANK_WITH_SONG = "displayRankWithSong";    
    ...
    public static final String PREFERENCES_KEY_JUMP2PLAYER = "jump2Player";
    public static final String PREFERENCES_KEY_JUMP2PLAYLIST = "jump2Playlist";
	...
	public static final String PREFERENCES_KEY_NOWPLAYING_ENABLED = "nowplayingEnabled";
    ...
    public static final String ALBUM_ART_FILE = "AllbumArt.jpg";
